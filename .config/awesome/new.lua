...
beautiful.init("/home/xyn/.config/awesome/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ "a", "b", "c", "d", "e" }, s, layouts[1])
end
-- }}}
...
mpdwidget = wibox.widget.textbox()
  vicious.register(mpdwidget, vicious.widgets.mpd,
    function (widget, args)
      ...
      else return '<span color="red">Now Playing:</span> '..
...
--  left_graphbox:add(uptimewidget)


  local right_graphbox = wibox.layout.fixed.horizontal()
  right_graphbox:add(uptimewidget)
